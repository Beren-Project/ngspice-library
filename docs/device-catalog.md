...
| `NG_INT_AW_RISE` | stable | Gated/clamped rising-edge reset integrator; `ng_int_rst(mode=1, aw_enable=true)` | `in rst out` | same as above | [`anti_windup.cir`](../examples/anti_windup.cir) | [`test_integrator_antiwindup_rise.cir`](../tests/test_integrator_antiwindup_rise.cir) | [Resettable integrators](devices/resettable-integrators.md#structure-and-signal-flow) |
| `NG_INT_AW_FALL` | stable | Gated/clamped falling-edge reset integrator; `ng_int_rst(mode=2, aw_enable=true)` | `in rst out` | same as above | [`anti_windup.cir`](../examples/anti_windup.cir) | [`test_integrator_antiwindup_fall.cir`](../tests/test_integrator_antiwindup_fall.cir) | [Resettable integrators](devices/resettable-integrators.md#structure-and-signal-flow) |
